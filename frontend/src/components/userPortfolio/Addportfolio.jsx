...
function Addportfolio({setaddportfolio}) {
    ...
    const handleAddContact = () => {
        if (contactmedia.trim() !== '' && contactvalue.trim() !== '') {
            setcontacts([...contacts, { media: contactmedia.trim(), value: contactvalue.trim() }]);
            setcontactmedia('');
            setcontactvalue('');
        }
    };
        ...
        <h4>contact</h4>
                        <div className="df">
                            ...
                            <input
                                ...
                                placeholder="Enter contact data"
                            />
                            <div className="primary-btn" onClick={handleAddContact}>Add</div>
                        </div>
                        <div className="df">
                            {contacts.map((contact, index) => (
                                <div key={index} style={{ display: 'inline-block', marginRight: '5px' }}>
                                    <div className="df addskill">
                                        {contact.media}: {contact.value}
                                        <span onClick={() => handleRemoveContact(index)}>X</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="df">
                            {education.map((education, index) => (
                                <div key={index} className="addskill df">
                                    ...
                                    <span className="" onClick={() => handleRemoveEducation(index)}>X</span>
                                </div>
                            ))}
                        </div>
                    </div>
